...
export default function Services() {
  ...
  const [selectedRatings, setSelectedRatings] = useState([]); // ratings selected
  ...
  useEffect(() => {
    ...
    // Search query from homepage search bar
    if (searchQuery) {
    ...
    if (selectedRatings.length > 0) {
      services = services.filter((s) => {
        // match rating threshold e.g. 4.8 corresponds to >= 4.8
