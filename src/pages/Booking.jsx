...
import { 
  ...
  IoPersonOutline, IoCardOutline, IoAddOutline, IoTrashOutline 
...
export default function Booking() {
  ...
  const { 
    bookingStep, setBookingStep, bookingData, setBookingData, 
  ...
  }, [cartItems, bookingStep, navigate]);
  ...
  const handleSelectSavedAddress = (addr) => {
    ...
    setBookingData(prev => ({ ...prev, address: addr }));
  ...
  const handleSelectPro = (pro) => {
    setBookingData(prev => ({ ...prev, professional: pro }));
    nextStep();
  };
              ...
              >
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-4 sm:grid-cols-7 gap-2">
                    {dates.map((d) => {
                      const isSelected = bookingData.date === `${d.dayName}, ${d.dayNum} ${d.month}`;
                      return (
                        <button
                          key={d.dateStr}
                          onClick={() => setBookingData(prev => ({ ...prev, date: `${d.dayName}, ${d.dayNum} ${d.month}` }))}
                ...
                <div className="space-y-3">
                  {[
                    ...
                    return (
                      <div
                        key={p.id}
                        onClick={() => setBookingData(prev => ({ ...prev, payment: p.id }))}
                      ...
                      >
                        <input
                          ...
                          name="payment"
                          checked={isSelected}
                          onChange={() => setBookingData(prev => ({ ...prev, payment: p.id }))}
