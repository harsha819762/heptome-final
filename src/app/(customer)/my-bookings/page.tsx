...
export default function MyBookingsPage() {
  ...
  const handleSubmitReview = async (e: React.FormEvent) => {
    ...
    await supabase.from("reviews").insert({
      booking_id: selectedBookingForRate.id,
      profile_id: selectedBookingForRate.customer_address?.profile_id,
      rating,
      comment: reviewText,
    });
            ...
            >
              ...
              <div className="space-y-3.5 py-2">
                <div className="flex gap-4 items-center">
                  ...
                  {tabLabel(b) === "Completed" && (
                    <button
                      onClick={() => handleRebook({ id: b.id, name: b.service_name, price: b.total_price })}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 border-t border-slate-100 text-xs font-semibold text-slate-500">
                <div className="space-y-1">
                  ...
                  <p className="text-[#1A1A2E] font-bold flex items-center gap-1">
                    <IoCalendarOutline /> {b.scheduled_date} • {b.scheduled_time}
                  </p>
                </div>
              ...
              {tabLabel(b) === "Completed" && (
                <div className="pt-4 border-t border-slate-100 flex justify-end">
                  <button
                    onClick={() => { setSelectedBookingForRate(b); setRating(5); setReviewText(""); }}
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
            ...
            >
              ...
              <p className="text-xs text-slate-500 leading-relaxed font-semibold">
                Are you sure you want to cancel booking <strong>{selectedBookingForCancel.booking_number}</strong>? This action cannot be undone.
              </p>
            ...
            >
              ...
              <form onSubmit={handleSubmitReview} className="space-y-4">
                ...
                <div className="flex gap-3 pt-2">
                  ...
                  <button type="submit" className="flex-1 btn-primary py-2.5 text-xs">
                    Submit Rating
                  </button>
                </div>
              </form>
